export const portfolioConfig = {
  ...
  // Contact Information
  email: "npandian515@gmail.com", // Replace with actual email if available
  ...
  socialLinks: {
    ...
    external: "na",
    github:
      "https://github.com/Neurvinch?tab=overview&from=2025-05-01&to=2025-05-05", // Assuming this is the GitHub link
  },
  ...
  seo: {
    ...
    authors: [
      {
        name: "NAVEEN PANDIAN",
        url: "https://github.com/Neurvinch?tab=overview&from=2025-05-01&to=2025-05-05",
      },
    ],
  },
